// Salvestada on võimalik ainult ühte tüüpi andmeid. 

string folderPath = @"C:\data";
string fileName = "shoppingList.txt"; // Faili võimalik Notepadiga avada
...
else
{
    ...
    Console.WriteLine($"File {fileName} has been created."); // C: Data kausta alt saab faili avada
    myShoppingList = GetItemsFromUser();
    File.WriteAllLines(filePath, myShoppingList);
}
